from db_query import get_server_secret, set_server_secret
from authlib import get_new_secret, get_half_secret, get_combined_secret, hash256
...
def increment(user_nonce, email, devid):
    ...
    set_server_secret(email, devid, new_server_secret)
